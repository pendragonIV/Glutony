...
public class LevelData : ScriptableObject
{
    ...
    public Level GetGluttonyChallengelAtIndex(int index)
    {
        return levels[index];
    }

    public List<Level> GetAllGluttonyChallenges()
    {
        return levels;
    }

    public void SetGluttonyChallengeData(int levelIndex, bool isPlayable, bool isCompleted, int achivement)
    {
